                        ...
                        <div class="panel-heading">
                            ...
                            <div class="options">
                                <div class="btn-toolbar">
                                    <a href='<?php echo url('SaleStatistic','export')?>' class="btn btn-default exportSaleStatistic"><i class="fa fa-cloud-download"></i><span class="hidden-sm"> 导出  </span></a>
                                </div>
                            </div>
                        </div>
...
$("#_table").ajaxTable({
	...
	"url": '<?php echo url('SaleStatistic')?>',
	"columns": [
            ...
            {"name":"skfs", "data": function(d){if(d["skfs"]==0)return '现金';else if(d["skfs"]==1)return '银行卡';else if(d["skfs"]==2)return '储值卡';},},
            {"name":"ysje", "data": "ysje", "sum": "ysje"},
            {"name":"ssje", "data": "ssje", "sum": "ssje"},
            {"name":"zlje", "data": "zlje", "sum": "zlje"},
            {"name":"staff_name", "data": "staff_name"},
            {"name":"user_name", "data": "user_name"},
            {"data": function(d){return '<a class="detailSaleStatistic" href="<?php echo url('SaleStatistic','detail')?>&sale_id='+d["id"]+'"></a>';}, "attr": "style='display:none'"}
		],
    "complete": function(d){
        $("#_table tbody tr").dblclick(function(){
            ajaxLoad($(this).find(".detailSaleStatistic").attr("href"));
        });
    }
});
$(".exportSaleStatistic").click(function(){
    var url = this.href;
