<?php if(isAjax()):?>
<form action="<?php echo $action?>" method="post" class="form-horizontal" id="customer_form">
...
<div class="modal-body">
    ...
    <div class="form-group">
        ...
        <div class="col-sm-6">
            <input type="text" name="sn" id="form_sn" class="form-control" value="<?php echo $row['sn']?>" required="required"/>
        </div>
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
        ...
        <div class="col-sm-6">
            <input type="text" name="contact" id="form_contact" class="form-control" value="<?php echo $row['contact']?>" required="required"/>
        </div>
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
        ...
        <div class="col-sm-6">
            <input type="text" name="consume" id="form_consume" class="form-control" value="<?php echo $row['consume']?>" required="required"/>
        </div>
    </div>
    <div class="form-group">
        <label class="col-sm-3 control-label">优惠</label>
        <div class="col-sm-6">
            <input type="text" name="offer" id="form_offer" class="form-control" value="<?php echo $row['offer']?>" required="required"/>
        </div>
    </div>
    <div class="form-group">
        <label class="col-sm-3 control-label">欠款</label>
        <div class="col-sm-6">
            <input type="text" name="overdraft" id="form_overdraft" class="form-control" value="<?php echo $row['overdraft']?>" required="required"/>
        </div>
    </div>
    <div class="form-group">
...
<script type="text/javascript">
    $('#customer_form').ajaxForm({
        ...
        success:function(d){
            if(d.state) {
                showSuccess(d.info);
                $("#customer_form").parent().parent().find(".close").click();
...
<div class="row">
    <div class="col-xs-12">
        <div class="panel panel-sky">
            ...
            <form action="<?php echo $action?>" method="post" class="form-horizontal row-border" id="customer_form">
            <?php if(!empty($row['id'])):?>
            <input type="hidden" name="id" value="<?php echo $row['id']?>"/>
            <?php endif;?>
            <?php echo inputHash();?>
            <div class="panel-body">                
                    ...
                    <div class="form-group">
                        <label class="col-sm-3 control-label">联系人</label>
                        <div class="col-sm-6">
                            <input type="text" name="contact" id="form_contact" required="required" class="form-control" value="<?php echo $row['contact']?>"/>
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-sm-3 control-label">电话</label>
                    ...
                    <div class="form-group">
                        <label class="col-sm-3 control-label">消费</label>
                        <div class="col-sm-6">
                            <input type="text" name="consume" id="form_consume" required="required" class="form-control" value="<?php echo $row['consume']?>"/>
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-sm-3 control-label">优惠</label>
                        <div class="col-sm-6">
                            <input type="text" name="offer" id="form_offer" required="required" class="form-control" value="<?php echo $row['offer']?>"/>
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-sm-3 control-label">欠款</label>
                        <div class="col-sm-6">
                            <input type="text" name="overdraft" id="form_overdraft" required="required" class="form-control" value="<?php echo $row['overdraft']?>"/>
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-sm-3 control-label">状态</label>
