...
$("#one_goods_modal_table").ajaxTable({
    ...
    "perpage": 20,
    "url": '<?php echo url('MemberExchange','member')?>',
    "columns": [
    ...
    <div id='wrap'>
        <div id="page-heading">
            <ol class="breadcrumb">
                ...
                <li><a href="<?php echo url('Member')?>">积分兑换</a></li>
...
$("#_table").ajaxTable({
    ...
    "complete": function(cb){
        $("#_table tbody tr").dblclick(function(){
            window.location.href='<?php echo url('MemberExchange','add')?>&id='+$(this).children("td:eq(0)").html();
        });
    }
});
</script>
