                        ...
                        <div class="panel-heading">
                            ...
                            <div class="options">
								<div class="btn-toolbar">
									<a href="<?php echo url('CustomerPay','customer')?>" class="btn btn-default addCustomerPay"><i class="fa fa-usd"></i><span class="hidden-sm"> 客户收款  </span></a>
									<a href="<?php echo url('CustomerPay','import')?>" class="btn btn-default importCustomerPay"><i class="fa fa-cloud-download"><span class="hidden-sm"> 导出</span></i></a>
								</div>
                            </div>
                        </div>
...
$(".addCustomerPay").click(function(){
    ajaxLoad(this.href);
    return false;
});
$(".importCustomerPay").click(function(){
    var url = this.href;
...
function oneGoodsModalFinish(d){
    ajaxLoad('<?php echo url('CustomerPay','add')?>&id='+d["id"]);
}
</script>
</body>
</html>