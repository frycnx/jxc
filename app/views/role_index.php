                        ...
                        <div class="panel-heading">
                            ...
                            <div class="options">
                                <div class="btn-toolbar">
                                    <a href="<?php echo url('Role','add')?>" class="btn btn-default addRole"><i class="fa fa-plus"></i><span class="hidden-sm"> 新增角色  </span></a>
                                    <a href="<?php echo url('Role','import')?>" class="btn btn-default importRole"><i class="fa fa-cloud-download"><span class="hidden-sm"> 导出</span></i></a>
                                </div>
                            </div>
                        </div>
...
$("#_table").ajaxTable({
	...
	"url": '<?php echo url('Role')?>',
	"columns": [
			{"name":"id", "data": "id"},
			{"name":"name", "data": "name"},
			{"name":"status", "data": function(d){return '<i class="fa '+(d["status"]=='1'?'fa-check-circle':'fa-times-circle')+'"></i>';} },
			{ "data": function(d){return '<div class="btn-group"><a class="editRole" href="<?php echo url('Role','edit')?>&id='+d["id"]+'" title="编辑"><i class="fa fa-edit"></i><span class="hidden-sm">编辑</span></a></div>&nbsp;<div class="btn-group"><a class="delRole" href="<?php echo url('Role','del')?>&id='+d["id"]+'" title="删除"><i class="fa fa-trash-o"></i><span class="hidden-sm">删除</span></a></div>';}, "sortable": false}
		],
