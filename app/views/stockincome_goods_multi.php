        ...
        <div class="modal-content">
            ...
            <form class="form-horizontal">
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <input type="text" name="id" required="required" class="form-control" readonly="readonly"/>
                    </div>
                </div>
                <div class="form-group">
                    <label class="col-sm-3 control-label">名称</label>
                    <div class="col-sm-9">
                        <input type="text" name="name" required="required" class="form-control" readonly="readonly"/>
                    </div>
                </div>
                <div class="form-group">
                    <label class="col-sm-3 control-label">规格</label>
                    <div class="col-sm-9">
                        <input type="text" name="spec" required="required" class="form-control" readonly="readonly"/>
                    </div>
                </div>
                <div class="form-group">
                    <label class="col-sm-3 control-label">折扣</label>
                    <div class="col-sm-9">
                        <input type="text" name="discount" required="required" class="form-control" readonly="readonly"/>
                    </div>
                </div>
                <div class="form-group">
...
$('#multi_goods_modal').on('show.bs.modal',function(e){
    ...
    $("#multi_goods_modal_table").ajaxTable({
        ...
        "perpage":10,
        "url": '<?php echo url('StockIncome','goods')?>',
