        ...
        <div class="modal-content">
            ...
            <form class="form-horizontal">
               ...
               <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <input type="text" placeholder="库存" name="stock" required="required" class="form-control" disabled="disabled"/>
                    </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <input type="text" placeholder="价格" name="price" required="required" class="form-control" disabled="disabled"/>
                    </div>
                </div>
                <div class="form-group">
...
$('#multi_goods_modal').on('show.bs.modal',function(e){
    ...
    $("#multi_goods_modal_table").ajaxTable({
        ...
        "url": '<?php echo url('StockAllocate','goods')?>',
        "data": {shop_id:$('#from_shop_id').val()},
        "columns": [
