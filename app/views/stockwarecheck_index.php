                    ...
                    <div class="panel panel-sky">
                        <div class="panel-heading">
                            ...
                            <div class="options">
								...
								<a href='<?php echo url('StockWarecheck','add')?>' class="btn btn-default"><i class="fa fa-plus"></i><span class="hidden-sm"> 新增盘点  </span></a>
								<a href='<?php echo url('StockWarecheck','add')?>' class="btn btn-default"><i class="fa fa-cloud-download"><span class="hidden-sm"> 导出</span></i></a>
								</div>
                            </div>
                        </div>
...
$("#_table").ajaxTable({
	...
	"url": '<?php echo url('StockWarecheck')?>',
	"columns": [
            ...
            {"name":"memo", "data": "memo"},
			{ "data": function(d){return d["status"]=='1'?'<div class="btn-group"><a class="addStockWarecheck" href="<?php echo url('StockWarecheck','add')?>&sn='+d["sn"]+'" title="查看"><i class="fa fa-edit"></i><span class="hidden-sm">查看</span></a></div>':'<div class="btn-group"><a class="addStockWarecheck" href="<?php echo url('StockWarecheck','add')?>&sn='+d["sn"]+'" title="编辑"><i class="fa fa-edit"></i><span class="hidden-sm">编辑</span></a></div>&nbsp;<div class="btn-group"><a class="delStockWarecheck" href="<?php echo url('StockWarecheck','del')?>&id='+d["id"]+'" title="删除"><i class="fa fa-trash-o"></i><span class="hidden-sm">删除</span></a></div>';}, "sortable": false}
		],
    "complete": function(cb){
        $('.delStockWarecheck').click(function(){
        $.ajax({
          type: "GET",
          url: $(this).attr('href'),
          dataType: "json",
        ...
        $("#_table tbody tr").dblclick(function(){
            window.location.href=$(this).find(".addStockWarecheck").attr("href");
        });
    }
});
</script>
