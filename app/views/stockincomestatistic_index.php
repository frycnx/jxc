                        ...
                        <div class="panel-heading">
                            ...
                            <div class="options">
                                <div class="btn-toolbar">
                                    <a href='<?php echo url('StockIncomeStatistic','export')?>' class="btn btn-default exportStockIncomeStatistic"><i class="fa fa-cloud-download"></i><span class="hidden-sm"> 导出  </span></a>
                                </div>
                            </div>
                        </div>
...
$("#_table").ajaxTable({
	...
	"url": '<?php echo url('StockIncomeStatistic')?>',
	"columns": [
            ...
            {"name":"memo", "data": "memo"},
            {"data": function(d){return '<a class="detailStockIncomeStatistic" href="<?php echo url('StockIncomeStatistic','detail')?>&income_id='+d["id"]+'"></a>';}, "attr": "style='display:none'"}
		],
    "complete": function(cb){
        $("#_table tbody tr").dblclick(function(){
            ajaxLoad($(this).find(".detailStockIncomeStatistic").attr("href"));
        });
    }
});
$(".exportStockIncomeStatistic").click(function(){
    var url = this.href;
