                        ...
                        <div class="panel-heading">
                            ...
                            <div class="options">
                                <div class="btn-toolbar">
                                    <a href='<?php echo url('TradeStatistic','export')?>' class="btn btn-default exportTradeStatistic"><i class="fa fa-cloud-download"></i><span class="hidden-sm"> 导出  </span></a>
                                </div>
                            </div>
                        </div>
...
$("#_table").ajaxTable({
	...
	"url": '<?php echo url('TradeStatistic')?>',
	"columns": [
            ...
            {"name":"customer_contact", "data": "customer_contact"},
            {"name":"ysje", "data": "ysje", "sum": "ysje"},
            {"name":"ssje", "data": "ssje", "sum": "ssje"},
            {"name":"yhje", "data": "yhje", "sum": "yhje"},
            {"name":"qkje", "data": "qkje", "sum": "qkje"},
            {"name":"user_name", "data": "user_name"},
            {"data": function(d){return '<a class="detailTradeStatistic" href="<?php echo url('TradeStatistic','detail')?>&trade_id='+d["id"]+'"></a>';}, "attr": "style='display:none'"}
		],
    "complete": function(d){
        $("#_table tbody tr").dblclick(function(){
            ajaxLoad($(this).find(".detailTradeStatistic").attr("href"));
        });
    }
});
$(".exportTradeStatistic").click(function(){
    var url = this.href;
