                        ...
                        <div class="panel-heading">
							...
							<div class="options">
								<div class="btn-toolbar">
									<a href='<?php echo url('GoodsBind','add')?>' class="btn btn-default"><i class="fa fa-plus"></i><span class="hidden-sm"> 新增捆绑  </span></a>
...
$("#_table").ajaxTable({
	...
	"columns": [
            ...
            {"name":"memo", "data": "memo"},
			{ "data": function(d){return d["status"]=='1'?'<div class="btn-group"><a class="addGoodsBind" href="<?php echo url('GoodsBind','add')?>&sn='+d["sn"]+'" title="查看"><i class="fa fa-edit"></i><span class="hidden-sm">查看</span></a></div>':'<div class="btn-group"><a class="addGoodsBind" href="<?php echo url('GoodsBind','add')?>&sn='+d["sn"]+'" title="编辑"><i class="fa fa-edit"></i><span class="hidden-sm">编辑</span></a></div>&nbsp;<div class="btn-group"><a class="delGoodsBind" href="<?php echo url('GoodsBind','del')?>&id='+d["id"]+'" title="删除"><i class="fa fa-trash-o"></i><span class="hidden-sm">删除</span></a></div>';}, "sortable": false}
		],
    "complete": function(cb){
        $('.delGoodsBind').click(function(){
        $.ajax({
          type: "GET",
          url: $(this).attr('href'),
          dataType: "json",
        ...
        $("#_table tbody tr").dblclick(function(){
            window.location.href=$(this).find(".addGoodsBind").attr("href");
        });
    }
});
</script>
