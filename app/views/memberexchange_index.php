                        ...
                        <div class="panel-heading">
                            ...
                            <div class="options">
								<div class="btn-toolbar">
									<a href="<?php echo url('MemberExchange','member')?>" class="btn btn-default addMemberExchange"><i class="fa fa-exchange"></i><span class="hidden-sm"> 积分兑换  </span></a>
									<a href="<?php echo url('MemberExchange','import')?>" class="btn btn-default importMemberExchange"><i class="fa fa-cloud-download"><span class="hidden-sm"> 导出</span></i></a>
								</div>
                            </div>
                        </div>
...
$("#_table").ajaxTable({
	...
	"url": '<?php echo url('MemberExchange')?>',
	"columns": [
            ...
            {"name":"current_point", "data": "current_point"},
...
$(".addMemberExchange").click(function(){
    ajaxLoad(this.href);
    return false;
});
$(".importMemberExchange").click(function(){
    var url = this.href;
...
function oneGoodsModalFinish(d){
    ajaxLoad('<?php echo url('MemberExchange','add')?>&id='+d["id"]);
}
</script>
</body>
</html>