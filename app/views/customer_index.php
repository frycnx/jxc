                        ...
                        <div class="panel-heading">
                            ...
                            <div class="options">
                                <div class="btn-toolbar">
                                    <a href="<?php echo url('Customer','add')?>" class="btn btn-default addCustomer"><i class="fa fa-plus"></i><span class="hidden-sm"> 新增客户  </span></a>
                                    <a href="<?php echo url('Customer','import')?>" class="btn btn-default importCustomer"><i class="fa fa-cloud-download"><span class="hidden-sm"> 导出</span></i></a>
								</div>
                            </div>
                        </div>
...
$("#_table").ajaxTable({
	...
	"columns": [
            ...
            { "data": function(d){return '<div class="btn-group"><a class="editCustomer" href="<?php echo url('Customer','edit')?>&id='+d["id"]+'" title="编辑"><i class="fa fa-edit"></i><span class="hidden-sm">编辑</span></a></div>&nbsp;<div class="btn-group"><a class="delCustomer" href="<?php echo url('Customer','del')?>&id='+d["id"]+'" title="删除"><i class="fa fa-trash-o"></i><span class="hidden-sm">删除</span></a></div>';}, "sortable": false}
		],
