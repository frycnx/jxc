                        ...
                        <div class="panel-heading">
							...
							<div class="options">
								<div class="btn-toolbar">
									<a href='<?php echo url('StockOutcome','add')?>' class="btn btn-default"><i class="fa fa-plus"></i><span class="hidden-sm"> 新增出库  </span></a>
...
$("#_table").ajaxTable({
	...
	"url": '<?php echo url('StockOutcome')?>',
	"columns": [
            {"name":"create_time", "data": function(d){return date('Y-m-d',d['create_time']);} },
			{"name":"sn", "data": "sn"},
            {"name":"type", "data": function(d){if(d['type']=='5'){return '采购退货';}else if(d['type']=='6'){return '商品报损';}else if(d['type']=='7'){return '商品借货';}else if(d['type']=='8'){return '其他出库';}} },
            ...
            {"name":"memo", "data": "memo"},
			{ "data": function(d){return d["status"]=='1'?'<div class="btn-group"><a class="addStockOutcome" href="<?php echo url('StockOutcome','add')?>&sn='+d["sn"]+'" title="查看"><i class="fa fa-edit"></i><span class="hidden-sm">查看</span></a></div>':'<div class="btn-group"><a class="addStockOutcome" href="<?php echo url('StockOutcome','add')?>&sn='+d["sn"]+'" title="编辑"><i class="fa fa-edit"></i><span class="hidden-sm">编辑</span></a></div>&nbsp;<div class="btn-group"><a class="delStockOutcome" href="<?php echo url('StockOutcome','del')?>&id='+d["id"]+'" title="删除"><i class="fa fa-trash-o"></i><span class="hidden-sm">删除</span></a></div>';}, "sortable": false}
		],
    "complete": function(cb){
        $('.delStockOutcome').click(function(){
        $.ajax({
          type: "GET",
          url: $(this).attr('href'),
          dataType: "json",
        ...
        $("#_table tbody tr").dblclick(function(){
            window.location.href=$(this).find(".addStockOutcome").attr("href");
        });
    }
});
</script>
