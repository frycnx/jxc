                        ...
                        <div class="panel-heading">
                            ...
                            <div class="options">
                                <div class="btn-toolbar">
                                    <a href='<?php echo url('StockOutcomeStatistic','export')?>' class="btn btn-default exportStockOutcomeStatistic"><i class="fa fa-cloud-download"></i><span class="hidden-sm"> 导出  </span></a>
                                </div>
                            </div>
                        </div>
...
$("#_table").ajaxTable({
	...
	"url": '<?php echo url('StockOutcomeStatistic')?>',
	"columns": [
            ...
            {"name":"memo", "data": "memo"},
            {"data": function(d){return '<a class="detailStockOutcomeStatistic" href="<?php echo url('StockOutcomeStatistic','Detail')?>&id='+d["id"]+'"></a>';}, "attr": "style='display:none'"}
		],
    "complete": function(cb){
        $("#_table tbody tr").dblclick(function(){
            ajaxLoad($(this).find(".detailStockOutcomeStatistic").attr("href"));
        });
    }
});
$(".exportStockOutcomeStatistic").click(function(){
    var url = this.href;
